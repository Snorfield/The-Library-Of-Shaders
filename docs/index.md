...
All shader code here is written to be valid **GLSL** or **OpenGL Shading Language**. We define a few variables that match the [ShaderToy](https://www.shadertoy.com/new) environment for ease of testing, but they can be easily adapted as needed.
...
This entire library, and all work inside it, is licensed under **Creative Commons Zero**. You can do anything you want with it, including clone the entire website. The license information is available on the [repository](https://github.com/Snorfield/The-Library-Of-Shaders/blob/main/LICENSE).
